...
Eval: a random 80/20 split. Single-window numbers were jumping around between
runs, so this shuffles once and holds out 20% -- much steadier estimates.
Final model is fit on the train split and saved for serving.
"""
...
def shuffle_split(
    ...
    """Shuffled 80/20 split, stratified on the label."""
